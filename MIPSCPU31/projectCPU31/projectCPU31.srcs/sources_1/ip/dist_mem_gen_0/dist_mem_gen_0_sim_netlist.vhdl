...
--               e:/vivado_projects/projectCPU31/projectCPU31.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_sim_netlist.vhdl
...
architecture STRUCTURE of dist_mem_gen_0_rom is
  ...
  attribute SOFT_HLUTNM of \spo[21]_INST_0_i_4\ : label is "soft_lutpair1";
...
\synth_options.dist_mem_inst\: entity work.dist_mem_gen_0_dist_mem_gen_v8_0_10_synth
     port map (
      a(10 downto 0) => a(10 downto 0),
      spo(25) => \^spo\(31),
      spo(24 downto 22) => \^spo\(29 downto 27),
      spo(21) => \^spo\(25),
      spo(20 downto 0) => \^spo\(20 downto 0)
    );
end STRUCTURE;
